# 💫🏅KBA WEBSITE:
<br><br>This is the Kerala Blockchain Academy website that user can see courses available in here and their details .<br><br> 🎯 Objective<br><br>USing this website users can esily follow and study the newest technology and can be a part of the technicalworld.<br><br> 🛠️ Built With<br>    -*Frontend* : HTML, Tailwind, JavaScript, React, CSS<br>    -*Backend* : Node.js, Express.js, MongoDB, Mongoose<br>    -*Tools*: Docker<br> <br>✨File Structure<br><br>  - *server*: Backend server configuration and models .<br>  - *ui*: Frontend user interface files for a seamless reservation experience.<br>  -* docker-composer*: Docker file that help as to run multi-container .<br>
